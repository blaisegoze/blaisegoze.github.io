...
const portfolioPageOrder = () => {
    ...
    const pagesAll = [{page: '/cush-tech', type: '3d video'}, {page: '/hex-x-talon', type: 'video'}, {page: '/px200r', type: 'video'}, {page: '/infinity-air', type: '3d video'}, {page: '/pure', type: '3d video'}, {page: '/variance', type: '2d'}, {page: '/overcome', type: '3d video'}, {page: '/davids', type: '3d'}, {page: '/nepenthe', type: '2d'}, {page: '/fantasy-tavern', type: '3d'}, {page: '/mutant-opie', type: '2d'}, {page: '/watermelon', type: '3d video'}, {page: '/logos', type: '2d'}, {page: '/lollipop', type: '3d'}, {page: '/balloon', type: '3d video'}, {page: '/la-rosa', type: '3d'}, {page: '/build-a-pet', type: '2d'}, {page: '/free-yourself', type: '2d'}, {page: '/turndown-cookie', type: 'video'}, {page: '/weddings', type: 'video'}];
    ...
    setupNavLink('r', document.querySelector('.arrow-right-link'));
    setupNavLink('l', document.querySelector('.arrow-left-link'));
}
